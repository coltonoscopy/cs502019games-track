...
function love.load()
    ...
    -- set LÖVE's default filter to "nearest-neighbor", which essentially
    ...
    -- set LÖVE's active font to the smallFont obect
...
function love.draw()
    ...
    -- new function just to demonstrate how to see FPS in LÖVE
    displayFPS()
